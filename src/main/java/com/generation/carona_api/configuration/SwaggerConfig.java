...
public class SwaggerConfig {
   ...
   OpenAPI springBlogPessoalOpenAPI() {
       return new OpenAPI()
           .info(new Info()
               .title("Projeto Caronas Compatilhadas")
               .description("Projeto Caronas Compatilhadas - Nexus Hub Dev")
               .version("v0.0.1")
               .license(new License()
                   .name("Nexus Hub Dev")
                   .url("https://github.com/Nexus-Hub-Dev/carona_api"))
               .contact(new Contact()
                   .name("Nexus Hub Dev")
                   .url("https://github.com/Nexus-Hub-Dev/carona_api")
                   .email("grupo1.java85@gmail.com")))
